					...
					<ul class="app_list">
                       ...
                       <!--  <li class="clear">
						...
						<li class="clear">
                            ...
                            <div class="app_content email_area">
								<!-- 화면에 보일 필요는 없는데 데이터를 담아서 보내야 하는 경우 hidden 태그를 사용한다 -->
						...
						<li class="clear">
							...
							<div class="app_content"><input type="text" class="w100p" id="name_lbl" placeholder="제목을 입력하세요" name="title" value="${dto.title}"/></div>
						</li>


						<li class="clear">
							<label for="content_lbl" class="tit_lbl">수정하기</label>
